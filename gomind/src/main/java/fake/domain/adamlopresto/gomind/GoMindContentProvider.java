...
public class GoMindContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "fake.domain.adamlopresto.gomind";
        ...
        switch (uriType) {
            ...
            case SERVINGS_DATED_HISTORY:
                ...
                queryBuilder.setTables("foods INNER JOIN servings ON foods._id=servings.food " +
                        ...
                        "AND history.date>=date("+DatabaseUtils.sqlEscapeString(date)+
                        ", 'localtime', 'weekday 1', '-7 days')");
                uri = HISTORY_URI;
                break;
            case DAILY_TOTAL:
